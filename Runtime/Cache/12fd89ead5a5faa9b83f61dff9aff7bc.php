...
<div id="nav" class="container_16 ao_nav">
    <div class="grid_16 ch-box">
        <a href="__APP__/Index/index">首页</a>&nbsp;&nbsp;&nbsp;<?php if(isLogin() == false){ ?><a href="__APP__/Member/Login">登录</a>&nbsp;&nbsp;&nbsp;<a href="__APP__/Member/Register">注册</a><?php }else{} ?>
    </div>
</div>
...
<script src="./Static/js/ao.js"></script>
    ...
    $("#ao_register_submit").click(function(){
        ...
        $.getJSON('__APP__/Public/VerifyCheck', {Verify:reg.verify.value}, function(data){
            ...
            if(reg.username.value.search(/(.*)/) != -1){
            ...
            if(reg.password.value.search(/(.*)/) != -1){
            ...
            if(reg.password2.value.search(/(.*)/) != -1){
            ...
            if(reg.qq.value.search(/(.*)/) != -1){
                ...
                msg.qq.innerHTML = 'P请输入正确的QQ号！';
                formCheck.qq = false;
            }
            if(reg.phone.value.search(/(.*)/) != -1){
