...
<div id="nav" class="container_16 ao_nav">
    ...
    <div id="order-view" class="container_16">
        <div class="grid_16 ch-box-lite">
            <div id="order-view-main" class="container_16">
                <div class="grid_2">
                    <a class="ao_box_head">雇主信息</a>
                    <hr />
                    <a class="ao_box_head">很长的用户名</a></p>
                    <a class="ao_box_head">信誉度：100</a></p>
                    <a class="ao_box_head">用户等级：10</a></p>
                    <a class="ao_box_head">十级会员</a></p>
                    <hr />
                    <button class="ch-btn">申请接单</button>
                </div>
                <div id="order-view-creater-info" class="grid_11">
                    <a class="ao_box_head"><h4><b>标题：网站制作，量大从优，3000-5000七天完成！</b></h4></a>
                    <hr />
                    <a class="ao_box_head">描述：</a><a class="ao_box_head_right">发布时间:2013-04-13 20:26</a><hr />后台处理程序：</p>
        ...
        注：信誉度有一个乘法系数a默认等于1，例如订单成功后双方加信誉度200*a=200</p>
            通过充值升级成为黄金会员后可以改变这个系数。黄金会员成功交易后取得的信誉度为5倍也就是a=5。同样的订单可以取得200*a=1000的信誉度。</p>
                    <hr />
                    <div>
			<a class="ao_box_head"><h4><b>申请接单者列表</b></h4></a>
			<hr />
                        <table class="ch-datagrid">
                            <thead>
                                <tr>
                                    <th scope="col">申请人</th>
                                    <th scope="col">申请人等级</th>
                                    <th scope="col">申请人头衔</th>
                                    <th scope="col">详细信息</th>
                                    <th scope="col">选他接单</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td><a href="__APP__/Member/Info/Id/1">专业建站</a></td>
                                    <td>10</td>
                                    <td>十级会员</td>
				    <td><a href="__APP__/Member/Info/Id/1">点击查看</a></td>
                                    <td>选他接单</td>
                                </tr>
                                <tr>
                                    <td><a href="__APP__/Member/Info/Id/1">专业建站</a></td>
                ...
                <div id="order-view-info" class="grid_3">
                    &nbsp;
